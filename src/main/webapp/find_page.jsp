...
<%
   ...
   // 가져온 리스트를 request 영역에 저장
   // ${phones}로 가져오기 위해
    request.setAttribute("phones", list);
    
    int pageSize = 7; //한 페이지에 보여줄 개수
    int currentPage = 1; //현재 페이지 번호
    // 사용자가 페이지 번호를 클릭했는지 확인
